...
export function UploadFaultFile() {
    ...
    // the json useState changes throughout execution
    const [json, setJson] = useState(null);

    // the jsonFile useState is the original json file
    const [jsonFile, setJsonFile] = useState(null);

    
    const uploadFile = (event) => {
        // Retrieves and sets files from the upload button and check if it is json
